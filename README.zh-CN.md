...
<img src="assets/hero-banner.svg" alt="LoreGraph——一排书页与漂浮的图谱节点，节点用细线连到书页上金色高亮的字段；slogan：'every node cites the page it came from.'" width="100%" />
...
[![Pipeline](https://img.shields.io/badge/PIPELINE-8_PASS-b8954a?style=for-the-badge&labelColor=1a1a1a)](#八步流水线)
[![Model](https://img.shields.io/badge/MODEL-Claude_Opus_4.8-b8954a?style=for-the-badge&labelColor=1a1a1a)](#配置)
...
一本书流经八步。切块和 GLUCOSE 步是确定性的，其余是 LLM 调用，全部走同一个加固过的客户端。
